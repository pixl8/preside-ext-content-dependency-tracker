...
component {
	...
	property name="dependent_content_record" relationship="many-to-one" relatedTo="tracked_content_record" required=true indexes="dependentRecordsAndField|3";

	property name="content_record_field" type="string"  dbtype="varchar" maxlength=100 required=true indexes="dependentRecordsAndField|2";
