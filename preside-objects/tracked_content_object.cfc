...
component {
	...
	property name="content_type"         type="string"  dbtype="varchar" maxlength=50    required=true renderer="objectName";
	property name="content_id"           type="string"  dbtype="varchar" maxlength=35    required=true;
	property name="orphaned"             type="boolean" dbtype="bit"     default="false" required=true;
	property name="hidden"               type="boolean" dbtype="bit"     default="false" required=true;
	property name="requires_scanning"    type="boolean" dbtype="bit"     default="false" required=true;
