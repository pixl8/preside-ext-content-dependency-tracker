...
component {
	...
	property name="content_type"         type="string"  dbtype="varchar" maxlength=50    required=true renderer="objectName" uniqueIndexes="contentTypeAndId|1" enum="dependencyTrackerContentTypes";
	property name="content_id"           type="string"  dbtype="varchar" maxlength=35    required=true                       uniqueIndexes="contentTypeAndId|2";
